...
export const createApplicationRouter = ({applicationModel, userModel, assetModel}) => {

    const applicationRouter = Router();

    const applicationController = new ApplicationController({applicationModel, userModel, assetModel});
